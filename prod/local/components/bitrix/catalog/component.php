...
// Оригинал: /bitrix/components/bitrix/catalog/component.php (+ правка проверки 404 для умного фильтра в корне каталога)
...
if ($arParams["SEF_MODE"] === "Y")
{
	...
	if($componentPage == "section")
	{
		...
		{
			$hasSectionSlug = isset($arVariables["SECTION_CODE"])
				|| (isset($arVariables["SECTION_CODE_PATH"]) && (string)$arVariables["SECTION_CODE_PATH"] !== '');
			$smartFilterPath = trim((string)($arVariables["SMART_FILTER_PATH"] ?? ''));
			$b404 |= !$hasSectionSlug && $smartFilterPath === '';
		}
	}
