...
<header class="page-header">
	...
	false
                ...
                <div class="page-header__contacts">
                    ...
                    <?php if ($headerPhone !== null) { ?>
                    <div class="page-header__phone">
                        <a class="link" href="<?= $h($headerPhone['href']) ?>"><?= $h($headerPhone['label']) ?></a>
                    </div>
                    <?php } ?>
                </div>
                    ...
                    <div class="page-header__cart minicart">
                        <a href="/cart/" class="minicart__link link">
                            <span class="minicart__icon">
                                ...
                                <span class="minicart__total<?= $cartQty > 0 ? '' : ' hidden' ?>">
                                    <span class="minicart__badge js-header-cart-count"><?= $h($cartCountBadge) ?></span>
                                </span>
                            </span>
                        </a>
                    </div>
